...
import { formatDate, getStatusColor } from '../../utils/claimUtils';
...
const ClaimDetail = () => {
  ...
  // Only allow file uploads if the claim is not resolved or rejected
  const canUploadFiles = claim.status !== 'Resolved' && claim.status !== 'Rejected';
            ...
            <dl>
              ...
              {claim.assignedTo && (
                <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{claim.assignedTo.name}</dd>
                </div>
              )}
              {claim.resolution && (
                <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        {canUploadFiles && (
          <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Upload relevant files to support your claim
              </p>
            </div>
