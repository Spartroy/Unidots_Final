              ...
              <div className="border-t border-slate-700 pb-3 pt-4">
                <div className="flex items-center px-5">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="text-sm font-medium text-slate-300">{user?.role === 'admin' ? 'Administrator' : 'Manager'}</div>
                  </div>
                  <NotificationDropdown colorClasses="bg-slate-700 text-slate-200 hover:bg-slate-600" />
                </div>
                <div className="mt-3 space-y-1 px-2">
                  ...
                  <Disclosure.Button
                    as="button"
                    onClick={logout}
                    className="block w-full text-left rounded-md px-3 py-2 text-base font-medium text-slate-200 hover:bg-slate-700 hover:text-white"
                  >
                    Sign out
                  </Disclosure.Button>
                </div>
